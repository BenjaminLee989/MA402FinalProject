...
struct PyPetscRegressorObject;

/* "petsc4py/PETSc.pxd":121
 * # --------------------------------------------------------------------
 * 
...
/* "petsc4py/PETSc.pxd":286
 *     cdef PetscTAOLineSearch taols
 * 
 * ctypedef public api class TAOTerm(Object) [             # <<<<<<<<<<<<<<
 *     type   PyPetscTAOTerm_Type,
 *     object PyPetscTAOTermObject,
*/
struct PyPetscTAOTermObject {
  struct PyPetscObjectObject __pyx_base;
  TaoTerm taoterm;
};
typedef struct PyPetscTAOTermObject PyPetscTAOTermObject;

/* "petsc4py/PETSc.pxd":292
 *     cdef PetscTAOTerm taoterm
 * 
...
typedef struct PyPetscRegressorObject PyPetscRegressorObject;
...
__PYX_EXTERN_C DL_IMPORT(PyTypeObject) PyPetscSNESLineSearch_Type;
...
__PYX_EXTERN_C DL_IMPORT(PyTypeObject) PyPetscTAOTerm_Type;
...
__PYX_EXTERN_C DL_IMPORT(PyTypeObject) PyPetscDMSwarmCellDM_Type;
...
__PYX_EXTERN_C DL_IMPORT(PyTypeObject) PyPetscRegressor_Type;

__PYX_EXTERN_C PetscErrorCode PetscViewerPythonGetContext(PetscViewer, void **);
__PYX_EXTERN_C PetscErrorCode PetscViewerPythonSetContext(PetscViewer, void *);
