...
class TAO(Object):
    ...
    def addTerm(self, prefix: str | None, scale: float, term: TAOTerm, params: Vec | None = None, mapmat: Mat | None = None) -> None: ...
...
class TAOTerm(Object):
    class Type:
        SHELL: Final[str] = ...
        CALLBACKS: Final[str] = ...
        SUM: Final[str] = ...
        HALFL2SQUARED: Final[str] = ...
        L1: Final[str] = ...
        QUADRATIC: Final[str] = ...
    def view(self, viewer: Viewer | None = None) -> None: ...
    def destroy(self) -> Self: ...
    ...
    def setFromOptions(self) -> None: ...
    def setUp(self) -> None: ...
    def setSolutionTemplate(self, x: Vec) -> None: ...
